...
In 2010, the case for programming with Processing became even stronger with the addition of the Android mode to the Processing environment, whose intent, in the words of the Processing all-volunteer team, is to make it &lquot;foolishly easy to create Android apps using the [Processing API.][1]&rquot;
...
[2]: http://en.wikipedia.org/wiki/Integrated_development_environment[3]: http://wiki.processing.org/w/Eclipse_Plug_In

###What You Need

To implement the projects in this book, you'll need the following tools:

* [Processing 3.0][4] (current pre-release is 3.0a5)* [Java 1.7 (or &lquot;Java 7&rquot;)][5]* [Android 4.0 Ice Cream Sandwich][6] (5.0 Lollipop is the current Android version, however 2.3 Gingerbread is sufficient for all projects except <ref linkend="chp.p2p" />, and <ref linkend="chp.nfc" />.)

[4]: http://processing.org/download/[5]: http://java.com/en/download/[6]: https://developer.android.com/studio/index.html#Other

<!--#run-sketch-android-emulator#introducing-android-touch-screen-->
